...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: Mayank agrawal</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;">|| PIET18CS086 || Sec: B || Roll No 29 ||</p></center>
   </div>
   </div>
   </div>
   """
    st.markdown(html_temp,unsafe_allow_html=True)
    st.header("Person Diagonsed")
    ...
    if st.button("About"):
      st.subheader("Developed by MAYANK AGRAWAL")
